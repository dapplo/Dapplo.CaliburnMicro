    ...
    .Does(()=>
{
    ...
    var projectFilePaths = GetFiles("./**/*.csproj")
		.Where(p => !p.FullPath.Contains("Test") p.FullPath.Contains("Cards") && !p.FullPath.Contains("Demo") && !p.FullPath.Contains("Diagnostics") &&!p.FullPath.Contains("packages") &&!p.FullPath.Contains("tools"));
